...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      <section class="content-header">
        <h1><i class="fa fa-clipboard"></i> Edit Category <small>Edit Category</small></h1>
        <ol class="breadcrumb">
                  ...
                  <div class="col-md-6">
                    <form action="{{ route('category.update',$category->id) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="category_title" name="category_title" value="{{ $category->category_name }}" class="form-control">
                      </div>
                      <div class="form-group">
